...
Accessing variable names that have spaces in it is very hard. So update
the names in `litter_df`.
...
Look at the data. Most frequent thing jeff does is print the data and
view the data set (from console)
...
Use `write_csv` rather than `read_csv`

``` r
write_csv(fellowship_rings_df,"data/fellowship_rings_df.csv")

#write_csv(dataframe you want to print, location you want to save it/name of file)
```
